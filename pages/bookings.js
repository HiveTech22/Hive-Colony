                    ...
                    <div className="">
                        <div className="p-4 flex justify-between items-center">
                            ...
                            <div className="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
                                ...
                                <h3 className="text-xl leading-none font-bold text-gray-900 mb-10">Your Bookings</h3>
                                    ...
                                    <table className="items-center w-full bg-transparent border-collapse">
                                        <thead className=''>
                                            <tr>
                                                ...
                                                <th className="thead">Created At</th>
                                        ...
                                        <tbody className="divide-y divide-primary">
                                            {
                                                bookings.length > 0 && (
                                                    ...
                                                    <tr key={key} className="text-gray-500">
                                                        <th className="tbody text-left">{booking.relationships.property.attribute.title}</th>
                                                        <td className="tbody text-gray-900 whitespace-nowrap p-4">{booking.relationships.property.relationships.agent.name}</td>
