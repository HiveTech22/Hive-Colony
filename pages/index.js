    ...
    return (
        <>
            ...
            <section className="relative  bg-blueGray-50">
                <div className="relative pt-24 pb-48 flex content-center items-center justify-center min-h-screen-75">
                    ...
                    <div className="container relative mx-auto">
                        <div className="items-center flex flex-wrap">
                            ...
                            <div className="pr-12">
                                ...
                                You are why we work so hard! Your Conform is our well being.
                                </p>
                            </div>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-wrap">
                            ...
                            <div className="w-full md:w-4/12 px-4 text-center">
                                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                                    ...
                                    <h6 className="text-xl font-semibold">Tested Freelancers</h6>
                                    <p className="mt-2 mb-4 text-blueGray-500">
                            ...
                            <div className="pt-6 w-full md:w-4/12 px-4 text-center">
                                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                                    ...
                                    <h6 className="text-xl font-semibold">Verified Properties</h6>
                                    <p className="mt-2 mb-4 text-blueGray-500">
